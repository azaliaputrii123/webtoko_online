    ...
    <form action="" method="post" enctype="multipart/form-data">
            ...
            <div>
             ...
             <div>
                ...
                <img src="../image/<?php echo $data['foto'] ; ?>" style="width: 50%; height:50%;">
             </div>
             <div>
            ...
            <div>
                ...
                <textarea name="detail" id="detail" cols="detail" rows="10" class="form-control">
